...
export default function OverviewQuatCamTay() {
      ...
      <div className="max-w-6xl mx-auto pt-6">
        ...
        <div className="grid md:grid-cols-2 gap-28">
          ...
          <div className="space-y-4">
            <h1 className="text-xl font-semibold">Sản phẩm: Quạt Cầm Tay</h1>
            <p className="font-medium">Các bước thực hiện:</p>
            <div className="relative">
              <img
                src="/src/assets/Product_core/4.png"
                alt="Quạt Cầm Tay"
                width={600}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>10 phút</span> {/* Giả định thời gian */}
              </div>
            </div>
          </div>
        </div>
