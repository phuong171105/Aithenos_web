...
export default function OverviewOngHeoTietKiem() {
      ...
      <div className="max-w-6xl mx-auto pt-6">
        ...
        <div className="grid md:grid-cols-2 gap-28">
          ...
          <div className="space-y-4">
            <h1 className="text-xl font-semibold">Sản phẩm: Ống Heo Tiết Kiệm</h1>
            <p className="font-medium">Các bước thực hiện:</p>
            <div className="relative">
              <img
                src="/src/assets/Product_core/1.png"
                alt="Ống Heo Tiết Kiệm"
                width={600}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>5 phút</span> {/* Giả định thời gian */}
              </div>
            </div>
          </div>
        </div>
